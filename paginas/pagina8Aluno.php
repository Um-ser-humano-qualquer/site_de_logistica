...
<body class="findo">
    ...
    <div class="legenda">
        <p class="laranja"> Não tem o produto pesquisado.</p>
        <p class="laranja2"> Quantidade insuficiente.</p>
        <p class="ciano"> Quantidade exata.</p>
        <p class="azul"> Quantidade a mais.</p>
    </div>

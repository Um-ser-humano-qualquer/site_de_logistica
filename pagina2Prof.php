    ...
    <body class="fundoP2">
        ...
        <div class="divProf2">
            ...
            <form method="POST0" action="">   
                <div class="posicaoP2">        
                    <div class="produto">
                        <input type="text" name="Produto" size="20" class="caixaTexto produtoPosition produtoPositionUp" placeholder="Produto">
                        <br>
                        <input type="text" name="Produto" size="20" class="caixaTexto produtoPosition" placeholder="Produto">
                        <br>
                        <input type="text" name="Produto" size="20" class="caixaTexto produtoPosition" placeholder="Produto">
                        <br>
                        <input type="text" name="Produto" size="20" class="caixaTexto produtoPosition" placeholder="Produto">
